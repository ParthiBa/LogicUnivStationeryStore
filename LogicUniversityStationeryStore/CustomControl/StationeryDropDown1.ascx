...
<script>
 ...
 <select name="webmen" class="webmenu" style="width: 266px"  onchange="setValue<%=uniqueKey%>($('.webmenu option:selected').text())">
  ...
  </select><asp:TextBox ID="txtGetValue" style="display:none" runat="server" Width="16px" ReadOnly="False" TextMode="SingleLine"></asp:TextBox>